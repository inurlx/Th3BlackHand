...
file_path = "C:/Users/Laptop/AppData/Local/Programs/Python/Python37/python.exe C:/Users/Laptop/Desktop/Th3BlackHand/Th3BlackHand.py" # Modify the paths accordingly 
...
status_path = r'C:\Users\%s\AppData\Roaming\Microsoft\Windows\Start Menu\Programs' % USER_NAME # i suppose this works for all windows users :) 
with open(bat_path + '\\' + "Th3BlackHand.bat", "w+") as bat_file:
    bat_file.write(r'start "" %s' % file_path)

f = open(status_path + '\\' + "status.txt", "w")
f.write("")
f.close()
...
while True:
    ...
    try:
        ...
        print("Internet Connection -> !OK")
        f = open(status_path + '\\' + "status.txt", "r")
        Status = f.read()
        if "True" == Status:
            print("allowed")
        elif "False" == Status:
